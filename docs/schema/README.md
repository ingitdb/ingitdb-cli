...
- **[Subcollections](subcollection.md)** (`.collection/subcollections/<name>.yaml`) — Hierarchical subsets of standard collections supporting distinct relation and subset logic structures while preserving exact collection syntax.
