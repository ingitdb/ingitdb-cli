...
- **[Subscribers](subscribers.md)** (`.ingitdb/subscribers.yaml`) — Built-in, configurable event handlers (webhook, email, Slack, Telegram, search index sync, and more) with no external tooling required.
