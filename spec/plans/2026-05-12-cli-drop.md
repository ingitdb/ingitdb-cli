...
| `source-selection` | 1 (--path; --github not implemented in this plan) |
...
- `source-selection --github` — the plan implements local source only. GitHub write paths for `drop` would require new helpers; deferred to a follow-up.
