...
name: spec-writer
description: >
  Use this agent to turn a vague feature idea, ROADMAP entry, or user story into
  a well-structured BACKLOG.md entry ready for go-engineer to act on. Produces a
  problem statement, acceptance criteria, implementation notes, and test cases.
  Use before go-engineer starts coding whenever requirements are unclear or
